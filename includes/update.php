   ...
   if(isset($_GET['user_id']))
    {
      ...
      $query="SELECT * FROM `registrer` WHERE id = $userid ";
    ...
    if(isset($_POST['update'])) 
    {
      ...
      $query = "UPDATE `registrer` SET username = '{$user}' , email = '{$email}' , password = '{$pass}',mb_number = {$mb} WHERE id = $userid";
  ...
  <div class="container ">
    <form action="" method="post">
      ...
      <div class="form-group">
        ...
        <input type="text" name="mb"  class="form-control" value="<?php echo $mb  ?>">
      </div>   
      <div class="form-group">
